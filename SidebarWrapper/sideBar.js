...
export function SideBar (){
    ...
    function createD(top, ax, dir) {
        return 'M0,0 ' + top + ',0 a' + ax + ',250 0 1,' + dir + ' 0,800 L0,800';
    }
    ...
    function openSideBar() {
        ...
        let mouseDownlistener = function (e) {
            document.getElementById('sidebar').setAttribute('viewBox', "0 0 300 800")
    ...
    document.addEventListener('mouseup', function (e){
        ...
        if (animating) 
            ...
            if (diffX < 40) {
                ...
                animatePathD(pathID, finalD, animTime, false, function () {
                    ...
                    sideBarCont.style.width = `${pathID.getBoundingClientRect().width - 2}px`;
                    sideBarCont.classList.add('active');
                    setTimeout(function () {
        ...
        delegate(document, ['touchend'], '#path', true, function (e) {
            ...
            if (diffX < 40) {
                ...
                animatePathD(pathID, finalD, animTime, false, function () {
                    sideBarCont.style.width = `${pathID.getBoundingClientRect().width}px`;
                    sideBarCont.classList.add('active');
                    setTimeout(function () {
                        document.addEventListener('click', closeSidebar);
    ...
    function closeSidebar(e) {
        ...
        setTimeout(()=>{
            document.getElementById('sidebar').setAttribute('viewBox', "0 0 50 800");
            sideBarCont.style.width = `${pathID.getBoundingClientRect().width - 2}px`;
         }, 1000)
